...
def generate_launch_description():
    ...
    rviz_file_name = 'recon_bot_config.rviz'
    ...
    #         parameters=[{
    #             'use_sim_time': False,
    #             'dynamixel_info': '/home/Ros2_Directory/recon_ws/src/recon_bot_description/config/dynamixel_controllers.yaml',  # Full path to the config file
    #         }]
    #     )
