...
class LaserScanMerger(Node):
    def __init__(self):
        ...
        self.front_angle_max_limit = math.radians(270)      # 270 องศา
        self.rear_angle_min_limit  = math.radians(-95)   # -95 องศา ขวาบน
        self.rear_angle_max_limit  = math.radians(152)      # 152 องศา
